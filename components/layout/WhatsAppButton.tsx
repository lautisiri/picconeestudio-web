...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-navy text-cream shadow-premium transition-all duration-300 ease-premium hover:scale-105 hover:bg-navy-light focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold sm:h-16 sm:w-16"
    >
